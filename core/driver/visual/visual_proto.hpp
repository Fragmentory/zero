...
{
    struct VisualPrototype : public Executor
    {
        VisualPrototype(driver::neopixel::Interface &_neopixel) :
            Executor(_neopixel)
        {
        }
        ...
        static const size_t NUMBER_OF_BEACONS = 4;
        static constexpr size_t BEACON_POSITION[NUMBER_OF_BEACONS] = {0, 1, 2, 3};
