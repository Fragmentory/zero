...
namespace core
{
    namespace soc
    {
         ...
         *
         */
        RP2040Stopwatch::RP2040Stopwatch(absolute_time_t &_reference) :
        ...
        /**
            \brief Reset
         */
        void RP2040Stopwatch::restart(void) { time_reference = get_absolute_time(); }
         ...
         */
        uint64_t RP2040Stopwatch::get_value(void) const
        {
